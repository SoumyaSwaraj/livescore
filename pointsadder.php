        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" action="index.php" class="signup-form needs-validation">
                    <h2 class="form-title" style="font-size:0.6em;margin-top:0;padding-top:0;"><?php echo $task; ?> <?php echo $pnt; ?> points to <?php echo $name; ?></h2>
